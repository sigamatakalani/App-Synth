...
public class graphStart : MonoBehaviour {
    ...
    void selectVertex(Transform selectedVertex)
    {
        selectedVertex.GetComponent<Renderer>().material.color = Color.blue;
    }
    ...
    void deselectVertex()
    {
        ...
        {
            if (vertex.transform.GetComponent<Renderer>().material.color != nodeColour)
            {
                vertex.transform.GetComponent<Renderer>().material.color = nodeColour;
            }
        }
    }
}
